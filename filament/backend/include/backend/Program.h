...
public:
    ...
    explicit Program(utils::RefCountedInternPool<SpecializationConstant>&
...
private:
    ...
    utils::RefCountedInternPool<SpecializationConstant>* mSpecializationConstantsInternPool;
