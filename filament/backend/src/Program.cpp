...
Program::Program(utils::RefCountedInternPool<SpecializationConstant>&
...
Program& Program::specializationConstants(SpecializationConstantsInfo specConstants) noexcept {
    ...
    // NOTE: This is allowed because RefCountedInternPool treats an empty list as having infinite
    // references held.
    mSpecializationConstantsInternPool->release(mSpecializationConstants);
